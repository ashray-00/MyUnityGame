...
public class GameManager : MonoBehaviour {
	...
	void refreshGUI() {
		...
		if (UILevel.text == "Level 1") {
			UIScore.text = "Score: " + score.ToString () + " of 5";
		} else {
			if (UILevel.text == "Level 2") {
				UIScore.text = "Score: " + score.ToString () + " of 10";
			} else {
				if (UILevel.text == "Level 3") {
					UIScore.text = "Score: " + score.ToString () + " of 15";
				} else {
					if (UILevel.text == "Level 4") {
						UIScore.text = "Score: " + score.ToString () + " of 20";
					} else {
						if (UILevel.text == "Level 5") {
							UIScore.text = "Score: " + score.ToString () + " of 25";
						}
					}
				}
			}
